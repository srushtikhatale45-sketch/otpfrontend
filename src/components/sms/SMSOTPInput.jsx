...
const SMSOTPInput = ({ phoneNumber, onVerify, onResend, isLoading, isResending }) => {
  ...
  return (
    <div className="w-full">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-gray-800">Verify via SMS</h2>
      ...
      <button
        ...
        disabled={isLoading}
        className="w-full bg-gradient-to-r from-green-600 to-teal-600 text-white py-3 px-4 rounded-lg font-semibold hover:from-green-700 hover:to-teal-700 transition-all disabled:opacity-50 mb-4"
      >
